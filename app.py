...
dataset = load_dataset("nroggendorff/openhermes", split="train").select(range(int(1.6e+5)))
...
config = LlamaConfig(
    ...
    num_hidden_layers=8 * 3,
    num_attention_heads=8 * 3,
    max_position_embeddings=512 * 3,
    rms_norm_eps=1e-6,
